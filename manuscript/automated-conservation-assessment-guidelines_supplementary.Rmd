...
knitr::include_graphics("../figures/figure-s2_downsampling-comparison.png")
```
...
knitr::include_graphics("../figures/figure-s3_group-comparison.png")
```

```{r criteria-comparison, out.width="100%", fig.cap="The accuracy of each AA method on threatened species in each study group assessed under the different IUCN Red List criteria. An assessment may cite more than one criterion."}
knitr::include_graphics("../figures/figure-s4_criteria-comparison.png")
```
...
predictor_table <-
  tribble(
    ...
    "Extent of occurrence (EOO)", "IUCN-threshold, decision stump, decision tree, random forest", "Minimum convex polygon", "-",
    "Latitude of range centroid", "decision tree, random forest", "Centroid of occurrence records", "-",
    "Minimum human population density (HPD)", "decision tree, random forest", "Minimum value", "Raster from [@University2018]",
    "Human footprint index (HFI)", "decision tree, random forest", "Mean value", "Raster from [@Venter2018]",
    "Forest loss", "decision tree, random forest", "Mean of proportion of pixels with forest loss from 5km$^2$ buffer around occurrence records", "Raster from [@Hansen2013]",
    "Elevation", "decision tree, random forest", "Maximum value", "Raster from [@Jarvis2008]",
    "Precipitation in the driest quarter", "decision tree, random forest", "Mean value", "Raster from [@Fick2017]",
    "Average annual temperature", "decision tree, random forest", "Mean value", "Raster from [@Fick2017]"
  )
...
criteria_table <- vroom(here("figures/table-2_criteria-table.csv"))
